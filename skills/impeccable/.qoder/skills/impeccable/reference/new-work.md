...
`node .qoder/skills/impeccable/scripts/concept-seed.mjs --scope surface --mode <mode>`
...
`node .qoder/skills/impeccable/scripts/surface-brief.mjs read <primary-target>`

`node .qoder/skills/impeccable/scripts/surface-brief.mjs write <primary-target> <body-file> [related-target ...]`
