...
`node .rovodev/skills/impeccable/scripts/concept-seed.mjs --scope surface --mode <mode>`
...
`node .rovodev/skills/impeccable/scripts/surface-brief.mjs write <primary-target> <body-file> [related-target ...]`
