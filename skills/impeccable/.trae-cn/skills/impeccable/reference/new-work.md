...
`node .trae-cn/skills/impeccable/scripts/concept-seed.mjs --scope surface --mode <mode>`
...
`node .trae-cn/skills/impeccable/scripts/surface-brief.mjs read <primary-target>`

`node .trae-cn/skills/impeccable/scripts/surface-brief.mjs write <primary-target> <body-file> [related-target ...]`
