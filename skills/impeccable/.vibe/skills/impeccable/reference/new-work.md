...
`node .vibe/skills/impeccable/scripts/concept-seed.mjs --scope surface --mode <mode>`
...
`node .vibe/skills/impeccable/scripts/surface-brief.mjs read <primary-target>`

`node .vibe/skills/impeccable/scripts/surface-brief.mjs write <primary-target> <body-file> [related-target ...]`
